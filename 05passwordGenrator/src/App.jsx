...
function App() {
  ...
  return (
    <>
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-10 bg-gray-800 text-black '> 
      <h1 className='text-white text-center'>Password Generator</h1>
      <div className='backflex shadow rounded-lg overflow-hidden  my-2 mb-4'>
